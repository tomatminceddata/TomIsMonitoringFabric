...
## This is latest and most complete version regarding the expansion of users:
cst_group_expansion_iterative_0_8_9_public.ipynb
Before you use this in a production environment read this:
+ https://publish.obsidian.md/minceddata/Getting+social/Blog/Monitoring+Fabric/Entra+ID+Group+Expansion+-+the+complete+guide
